...
export function jumpLink({ url, params, ZZCAppArg, noBook }) {
    formatJump(generateLink({ url, params, ZZCAppArg, noBook }));
}
 ...
 * @param {*} param0
 */
export function jumpLinkUseReplace({ url, params, ZZCAppArg, noBook }) {
    formatReplaceUrl(generateLink({ url, params, ZZCAppArg, noBook }));
}

// 合并参数并生成一个url
export function generateLink({ url, params, ZZCAppArg, noBook }) {
